...
public class MapPanel extends JPanel
{
	...
	public void paintTextArea(Graphics g)
	{
		//draw the White back drop
		g.setColor(Color.WHITE);
		g.fillRect(textMinX, textMinY, textMaxX-textMinX, 165);
	...
	public void paintListOfRecievedMessages(Graphics g, ArrayList<String> list)
	{
		if(list != null)
		{
			for(int i =1; i<=5; i++)
